...
checks = {
    ...
    "src/activities/x4plus/X4PlusMenuActivity.cpp": ["Study Cards", "Qur'an", "Clippings", "goToX4PlusStudy", "goToX4PlusQuran", "goToX4PlusClippings", "Prayer", "Focus / Pomodoro", "QR Wallet", "Calculator", "Phone / PC Transfer", "goToFileTransfer", "goToPhoneTransfer", "goToLibrary", "Games", "Minesweeper", "2048", "Organizer", "Utilities", "goToX4PlusMinesweeper", "goToX4Plus2048"],
