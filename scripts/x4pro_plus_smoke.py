...
checks = {
    ...
    "src/activities/x4plus/X4PlusQuran13Activity.h": ["kPageCount = 847", "quran13-state.json", "/.inkos/quran13/pages"],
    "src/activities/x4plus/X4PlusQuran13Activity.cpp": ["QUL / Tarteel resource 313", "Taj 13-line Mushaf", "AI is disabled here", "page-001.png ... page-847.png"],
