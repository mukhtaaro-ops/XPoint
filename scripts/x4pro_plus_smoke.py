...
checks = {
    ...
    "src/activities/x4plus/X4PlusListActivity.cpp": ["Mode::Study", "Mode::Quran", "Question :: Answer", "x4plus-study.json", "x4plus-quran.json"],
    "src/activities/x4plus/X4PlusMenuActivity.cpp": ["Study Cards", "Qur'an", "goToX4PlusStudy", "goToX4PlusQuran"],
