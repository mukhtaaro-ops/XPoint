...
namespace {
constexpr std::array<UIIcon, 16> kIcons = {Book, Blocks, Blocks, Blocks, Recent, Bookmark, Text, Blocks, Bookmark, Book, Bookmark, Text, Recent, Recent, Blocks, Text};
}
...
void X4PlusMenuActivity::activateSelection() {
  switch (selectedIndex) {
    ...
    case 2: activityManager.goToX4PlusMinesweeper(); break;
    case 3: activityManager.goToX4Plus2048(); break;
    case 4: activityManager.goToX4PlusCalendar(); break;
    case 5: activityManager.goToX4PlusTasks(); break;
    case 6: activityManager.goToX4PlusNotes(); break;
    case 7: activityManager.goToX4PlusCards(); break;
    case 8: activityManager.goToX4PlusStudy(); break;
    case 9: activityManager.goToX4PlusQuran(); break;
    case 10: activityManager.goToX4PlusQuranNotes(); break;
    case 11: activityManager.goToX4PlusClippings(); break;
    case 12: activityManager.goToX4PlusPrayer(); break;
    case 13: activityManager.goToX4PlusFocus(); break;
    case 14: activityManager.goToX4PlusWallet(); break;
    case 15: activityManager.goToX4PlusCalculator(); break;
    default: break;
  }
}
...
void X4PlusMenuActivity::render(RenderLock&&) {
  ...
  const std::array<const char*, 16> labels = {
      "Library", "Phone / PC Transfer", "Games: Minesweeper", "Games: 2048",
